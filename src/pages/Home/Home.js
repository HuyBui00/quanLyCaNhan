...
import { formatVietnameseDate } from "../../Utilities/FormatData/DateTime";
...
const Home = () => {
  ...
  useEffect(() => {
    setTasks([
      ...
      {
        id: 3,
        title: "Gọi thợ sửa ống nước",
        date: dayjs("2025-04-30"),
        tag: "Gọi thợ sửa ống nước",
        color: "orange",
        completed: true,
      },
      {
            ...
            <Card className="progress-card">
              ...
              >
                <div style={{ fontSize: "20px", marginTop: "15px" }}>
                  <b>Công việc trong ngày - {total}</b>
                </div>
                  ...
                  renderItem={(item) => (
                    <List.Item
                      ...
                      actions={[
                        ...
                        <Button
                          type="link"
                          danger
                          onClick={() => deleteRow(item.id, tasks, setTasks)}
                        >
                          <Tooltip title="Xóa">
                    ...
                    >
                      <List.Item.Meta
                        ...
                        description={formatVietnameseDate(item.date)}
                      />
